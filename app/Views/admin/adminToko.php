        ...
        <tr>
          ...
          <td>
            ...
            <?= csrf_field(); ?>
              ...
              <a type="button" class="btn btn-primary btn-sm col-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop">EDIT</a>
          </td>
        </tr>
        <?php $i++; }?>
      </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action='<?=base_url();?>/produkController/tambahProduk' method='POST' >
        <div class="mb-3">
